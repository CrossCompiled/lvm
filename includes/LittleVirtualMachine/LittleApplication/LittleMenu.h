//
// Created by kaspersk on 10/19/16.
//

#ifndef LITTLEVIRTUALMACHINE_LITTLEMENU_H
#define LITTLEVIRTUALMACHINE_LITTLEMENU_H
...
#endif //LITTLEVIRTUALMACHINE_LITTLEMENU_H
